package com.capgemini.onlinebanking.utility;
...
public class DBConnection {
	 ...
	 ***************************************************************************************/
	private DBConnection() throws BankingException {
		try {
	...
	public static DBConnection getInstance() throws BankingException {
	...
	public Connection getConnection() throws BankingException {
		try {
			...
			throw new BankingException(" Database connection problem");
		}
		return conn;
	}
